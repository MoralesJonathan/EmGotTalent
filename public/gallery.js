...
xhr.onreadystatechange = () => {
    ...
    if (xhr.readyState === 4 && regex.test(xhr.status)) {
        ...
        for(videoObj of videos){
            document.querySelector('#gallery .videos').innerHTML += `<div class="col"><iframe type="text/html" width="200" height="200" src="https://www.youtube-nocookie.com/embed/${videoObj.vid}?controls=0&disablekb=1&modestbranding=1&iv_load_policy=3" frameborder="0" allowfullscreen></iframe></div>`
        }
